...
+ (NSArray *)allKnownPlanets
{
    ...
    NSArray *planetInformation = [[NSArray alloc] init];
    ...
    planetInformation = @[mercuryDictionary,venusDictionary,earthDictionary,marsDictionary,jupiterDictionary,saturnDictionary,uranusDictionary,neptuneDictionary];
